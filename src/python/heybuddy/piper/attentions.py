...
from heybuddy.piper.common import subsequent_mask
from heybuddy.piper.modules import LayerNorm
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :param kernel_size: kernel size
        :param p_dropout: dropout rate
        :param proximal_bias: proximal bias
        :param proximal_init: proximal init
        """
        super().__init__()
        self.hidden_channels = hidden_channels
        self.filter_channels = filter_channels
    ...
    def forward(
        ...
        :param x_mask: decoder input mask
        :param h: encoder output
        :param h_mask: encoder output mask
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(
        ...
        if proximal_init:
            with torch.no_grad():
                ...
                self.conv_k.bias.copy_(self.conv_q.bias) # type: ignore[union-attr,arg-type]
    ...
    def _get_relative_embeddings(self, relative_embeddings: torch.Tensor, length: int) -> torch.Tensor:
        ...
        :param relative_embeddings: relative embeddings
        :param length: length
